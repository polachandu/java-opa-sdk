...
public class Evaluator implements io.github.openpolicyagent.opa.rego.Evaluator {
  ...
  private boolean invokeBuiltin(
    ...
    if (ctx.builtinRegistry != null && ctx.builtinRegistry.hasBuiltIn(name)) {
      try {
        ...
        return false;
      } catch (io.github.openpolicyagent.opa.ast.builtin.BuiltinError e) {
        if (ctx.isStrictBuiltinErrors()) {
          throw e;
        }
        return false;
  ...
  public static class Builder {
    ...
    private io.github.openpolicyagent.opa.ast.builtin.BuiltinRegistry builtinRegistry;
    ...
    public Builder withBuiltinRegistry(
        io.github.openpolicyagent.opa.ast.builtin.BuiltinRegistry registry) {
    ...
    public Evaluator build() {
      ...
      if (builtinRegistry != null) {
        io.github.openpolicyagent.opa.rego.Engine.Builder.validateRequiredBuiltins(
