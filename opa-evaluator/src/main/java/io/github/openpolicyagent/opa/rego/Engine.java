...
import io.github.openpolicyagent.opa.bundle.BundleLoader;
...
import io.github.openpolicyagent.opa.mapper.RegoMapper;
 ...
 *       using (services) io.github.openpolicyagent.opa.Opa Opa, refresh is called automatically on
 *       bundle activation.
...
public class Engine {
  ...
  public void refresh() {
    ...
    this.evaluator =
        new io.github.openpolicyagent.opa.ir.Evaluator.Builder()
            .withPolicy(policy)
  ...
  public static class Builder {
     ...
     * @throws io.github.openpolicyagent.opa.ir.FunctionNotFoundError if any required functions are
     *     missing
     */
    public static void validateRequiredBuiltins(Policy policy, BuiltinRegistry registry) {
      ...
      if (policy.getStaticField() != null && policy.getStaticField().getBuiltinFuncs() != null) {
        for (io.github.openpolicyagent.opa.ir.policy.BuiltinFunc builtinFunc :
      ...
      if (!missingFunctions.isEmpty()) {
        ...
        io.github.openpolicyagent.opa.ir.FunctionNotFoundError error =
            new io.github.openpolicyagent.opa.ir.FunctionNotFoundError(firstMissing);
     ...
     * @throws io.github.openpolicyagent.opa.ir.PolicyNotFoundException if no policy is found for the
     *     default entrypoint
     */
    public Engine build() {
      if (store == null) {
      ...
      Policy policy = store.getIrPolicyForEntrypoint(defaultEntrypoint);
      if (policy == null) {
        throw new io.github.openpolicyagent.opa.ir.PolicyNotFoundException(defaultEntrypoint);
      }
  ...
  public static class PreparedQuery {
    ...
    private final io.github.openpolicyagent.opa.ir.PreparedPlan preparedPlan;
     ...
     * {@link io.github.openpolicyagent.opa.ir.PreparedPlan PreparedPlan}. If the engine is refreshed
      ...
      public PreparedQuery build() {
        ...
        this.preparedPlan =
            new PreparedPlan.Builder()
                .warmUp(
                    entrypointToWarm,
                    (io.github.openpolicyagent.opa.ir.Evaluator) engine.evaluator)
                .build();
