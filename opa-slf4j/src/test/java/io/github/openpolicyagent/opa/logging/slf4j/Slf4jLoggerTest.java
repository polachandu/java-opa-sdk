package io.github.openpolicyagent.opa.logging.slf4j;
...
class Slf4jLoggerTest {
    ...
    private static final String LOGGER_NAME = "io.github.openpolicyagent.opa.test";
    ...
    void defaultConstructor_usesDefaultLoggerName() {
        ...
        String defaultName = "io.github.openpolicyagent.opa";
        LoggerContext ctx = (LoggerContext) LogManager.getContext(false);
        Configuration config = ctx.getConfiguration();
